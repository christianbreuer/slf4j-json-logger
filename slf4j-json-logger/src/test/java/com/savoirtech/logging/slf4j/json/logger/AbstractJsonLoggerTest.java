...
public class AbstractJsonLoggerTest {
	...
	public void setup() {
		...
		this.gson = new GsonBuilder().disableHtmlEscaping().serializeNulls()
				.create();
	...
	public void json() {
		JsonElement jsonElement = gson
				.toJsonTree(new String[]{"value1", "value2"});
	...
	public void exception() {
		logger.exception("myException", new RuntimeException("Something bad"))
				.log();
	...
	public void containsThreadName() {
		...
		assert (logMessage.contains("\"thread_name\":\""
	...
	public void containsClassName() {
		logger.message("Some message").log();
		assert (logMessage.contains(
				"\"class\":\"com.savoirtech.logging.slf4j.json.logger.AbstractJsonLoggerTest\""));
	}
