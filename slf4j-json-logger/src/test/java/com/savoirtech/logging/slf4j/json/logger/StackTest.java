...
public class StackTest {
	...
	public void stack() {
		...
		assert (logMessage.contains(
				"\"stacktrace\":\"com.savoirtech.logging.slf4j.json.logger.StackTest$Class4.logMe(StackTest.java:81)\\n\\tat com.savoirtech.logging.slf4j.json.logger.StackTest$Class3.logMe(StackTest.java:71)\\n\\tat com.savoirtech.logging.slf4j.json.logger.StackTest$Class2.logMe(StackTest.java:59)\\n\\tat com.savoirtech.logging.slf4j.json.logger.StackTest$Class1.logMe(StackTest.java:47)"));
	}
